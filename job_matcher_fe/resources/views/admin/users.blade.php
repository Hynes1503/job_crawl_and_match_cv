                ...
                <tbody>
                    ...
                    @foreach($users as $user)
                        @if($previousRole !== null && $previousRole !== $user->role)
                            ...
                            <tr>
                                <td colspan="6" style="padding: 0; height: 8px; background: linear-gradient(to right, transparent, #00b4ff, transparent); opacity: 0.6;"></td>
                            </tr>
                            <!-- Tiêu đề nhóm mới -->
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 16px; font-weight: 600; color: #00ffaa; font-size: 1.1rem; background: rgba(0, 255, 170, 0.08);">
